...
export default function ProfileEditForm({ user }: ProfileEditFormProps) {
  ...
  const handlePortfolioUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (result.success && result.image) {
      ...
      setSuccessMessage("Portfolio image added!");
      setTimeout(() => setSuccessMessage(null), 3000);
    } else {
  ...
  const handlePortfolioDelete = async (imageId: string) => {
    ...
    if (result.success) {
      ...
      setSuccessMessage("Portfolio image deleted");
      setTimeout(() => setSuccessMessage(null), 3000);
    } else {
      ...
      <form action={formAction} className="space-y-8">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full rounded-md border ${
              getFieldError("displayName") ? "border-red-300 focus:ring-red-500" : "border-gray-300 focus:ring-orange-500"
            } focus:border-transparent focus:ring-2 px-3 py-2`}
        ...
        <div>
          ...
          <textarea
            ...
            maxLength={500}
            className={`w-full rounded-md border ${
              getFieldError("bio") ? "border-red-300 focus:ring-red-500" : "border-gray-300 focus:ring-orange-500"
            } focus:border-transparent focus:ring-2 px-3 py-2`}
