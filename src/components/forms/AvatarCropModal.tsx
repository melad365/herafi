            ...
            <div className="p-6">
              ...
              <div className="flex gap-3 justify-end">
                ...
                <button
                  ...
                  disabled={isUploading}
                  className="bg-burgundy-800 hover:bg-burgundy-700 text-white font-medium px-6 py-2 rounded-md transition-colors duration-200 disabled:opacity-50 flex items-center gap-2"
                >
                  {isUploading && (
